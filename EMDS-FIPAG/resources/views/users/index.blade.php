    ...
    <div class="col m11 s12">
      <div class="row">
        <h3 class="flow-text"><i class="material-icons">person</i> Usuarios
          <button data-target="modal1" class="btn modal-trigger right">Adicionar Novo</button>
        </h3>
    ...
    <div class="divider"></div>
      ...
      <div class="row">
        <div class="col m6 s12 input-field">
          ...
          <select name="department_id" id="department_id">
            <option value="" disabled selected>Escolhe o departamento</option>
            @if(count($depts) > 0)
      ...
      <div class="row">
        ...
        <div class="col m6 s12 input-field">
          ...
          <label for="password-confirm">Confirma o Password</label>
        </div>
      </div>
  </div>
