...
<div class="row">
  <div class="section">
    ...
    <div class="col m11 s12">
      <div class="row">
        <h3 class="flow-text"><i class="material-icons">group</i> Departmentos
          <button data-target="modal1" class="btn waves-effect waves-light modal-trigger right">Adicionar Novo</button>
        </h3>
        ...
        <div class="card-content">
          <table class="responsive-table bordered centered highlight">
            ...
            <tbody>
              ...
              @else
                <tr>
                  <td colspan="3"><h5 class="teal-text">Nenhum Departamento foi adicionado</h5></td>
                </tr>
              @endif
            </tbody>
          </table>
